; ModuleID = '/home/CONNECT/xmeng027/work/HKS-Accelerator-hanxu/openfhe-for-HKS-ACC/src/fpga_backend/Solution_Compute_BConv/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_Compute_BConv_ir([64 x [64 x i64]]* noalias nocapture nonnull "fpga.decayed.dim.hint"="8" %in_x, [5 x i64]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="3" %in_w, i64* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="5" %out_mod, i64* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="5" %out_k_half, i64* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="5" %out_m_barrett, i32 %sizeP) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_Compute_BConv_hw([8 x [64 x [64 x i64]]]* %in_x_copy, [3 x [5 x i64]]* %in_w_copy, [5 x i64]* %out_mod_copy, [5 x i64]* %out_k_half_copy, [5 x i64]* %out_m_barrett_copy, i32 %sizeP)
...
declare void @apatb_Compute_BConv_hw([8 x [64 x [64 x i64]]]*, [3 x [5 x i64]]*, [5 x i64]*, [5 x i64]*, [5 x i64]*, i32)
...
define void @Compute_BConv_hw_stub_wrapper([8 x [64 x [64 x i64]]]*, [3 x [5 x i64]]*, [5 x i64]*, [5 x i64]*, [5 x i64]*, i32) #5 {
entry:
  ...
  call void @Compute_BConv_hw_stub([64 x [64 x i64]]* %6, [5 x i64]* %7, i64* %8, i64* %9, i64* %10, i32 %5)
...
declare void @Compute_BConv_hw_stub([64 x [64 x i64]]* noalias nocapture nonnull, [5 x i64]* noalias nocapture nonnull readonly, i64* noalias nocapture nonnull readonly, i64* noalias nocapture nonnull readonly, i64* noalias nocapture nonnull readonly, i32)
