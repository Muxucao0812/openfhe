...
set_target_properties(OPENFHEcore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEcore.so.1.4.0"
  IMPORTED_SONAME_RELEASE "libOPENFHEcore.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS OPENFHEcore )
list(APPEND _IMPORT_CHECK_FILES_FOR_OPENFHEcore "${_IMPORT_PREFIX}/lib/libOPENFHEcore.so.1.4.0" )
...
set_target_properties(OPENFHEpke PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEpke.so.1.4.0"
  IMPORTED_SONAME_RELEASE "libOPENFHEpke.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS OPENFHEpke )
list(APPEND _IMPORT_CHECK_FILES_FOR_OPENFHEpke "${_IMPORT_PREFIX}/lib/libOPENFHEpke.so.1.4.0" )
...
set_target_properties(OPENFHEbinfhe PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOPENFHEbinfhe.so.1.4.0"
  IMPORTED_SONAME_RELEASE "libOPENFHEbinfhe.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS OPENFHEbinfhe )
list(APPEND _IMPORT_CHECK_FILES_FOR_OPENFHEbinfhe "${_IMPORT_PREFIX}/lib/libOPENFHEbinfhe.so.1.4.0" )
